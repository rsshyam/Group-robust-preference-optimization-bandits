...
if __name__ == "__main__":
    ...
    project = 'bandits_dpo'
    group = 'state_dim2action_num8group_num2pref_data_num90weights[0.2,0.8]feature_typeswappedeval_metricargmax'
    ...
    base_folder = f'wandb-plots/closed_form_rand/{len(filters_dicts)}_{group}_deterministic_{str(filters_dicts[0]["config.deterministic"])}'
