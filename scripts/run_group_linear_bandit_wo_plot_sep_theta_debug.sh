...
REG_COEF=0.1
STATE_DIM=1
DPO_NUM_ITERS=200000
STEP_SIZE=0.1
#DPO_ADA_COEF=0.000001

# Create log directory with timestamp
LOG_DIR="log-weighted-dpo_sep/debug/dpo/$(date +'%Y_%m_%d_%H_%M_%S')_$DPO_NUM_ITERS"
mkdir -p "$LOG_DIR"
...
do
    ...
    do
        python -m experiments.run_group_linear_bandit_sep_theta_debug \
        --mle_adaptive \
        --state_dim ${STATE_DIM} \
