...
if __name__ == "__main__":
    ...
    project = 'bandits_dpo'
    group = 'state_dim2action_num8group_num2pref_data_num250weights[0.2,0.8]feature_typesameeval_metricargmax'
    group1 = 'state_dim2action_num8group_num2pref_data_num210weights[0.2,0.8]feature_typesameeval_metricargmax'
    group2 = 'state_dim2action_num8group_num2pref_data_num180weights[0.2,0.8]feature_typesameeval_metricargmax'
    group3 = 'state_dim2action_num8group_num2pref_data_num150weights[0.2,0.8]feature_typesameeval_metricargmax'
    ...
    for filters_dict in filters_dicts:
        ...
        for metric in metrics_to_collect:
            ...
            data_num=filters_dict['config.pref_data_num']
    ...
    for j,metric in enumerate(['reward_err_1', 'reward_err_2']):
        ...
        for i, filters_dict in enumerate(filters_dicts):
            ...
            if len(avg_values) != len(iteration_index):
                ...
                extended_avg_values = np.append(avg_values, [avg_values[-1]] * (len(iteration_index) - len(avg_values)))
                extended_sem_values = np.append(sem_values, [sem_values[-1]] * (len(iteration_index) - len(sem_values)))
                plt.plot(iteration_index, extended_avg_values, label=metric+'_'+weight+'_'+ algo + '_data_num_' + str(data_num))
                plt.fill_between(iteration_index, extended_avg_values - extended_sem_values, extended_avg_values + extended_sem_values, alpha=0.2)
            else:
                plt.plot(iteration_index, avg_values, label=metric+'_'+weight+'_'+ algo + '_data_num_' + str(data_num))
                plt.fill_between(iteration_index, avg_values - sem_values, avg_values + sem_values, alpha=0.2)
    ...
    for j,metric in enumerate(['group_weight_1', 'group_weight_2']):
        ...
        for i, filters_dict in enumerate(filters_dicts):
            ...
            if len(avg_values) != len(iteration_index):
                ...
                extended_avg_values = np.append(avg_values, [avg_values[-1]] * (len(iteration_index) - len(avg_values)))
                extended_sem_values = np.append(sem_values, [sem_values[-1]] * (len(iteration_index) - len(sem_values)))
                plt.plot(iteration_index, extended_avg_values,color=color, label=metric+'_'+weight+'_'+ algo + '_data_num_' + str(data_num))
                ...
                plt.plot(iteration_index, avg_values,color=color, label=metric+'_'+weight+'_'+ algo + '_data_num_' + str(data_num))
    ...
    for j,metric in enumerate(['train_group_loss_1','train_group_loss_2']):
        ...
        for i, filters_dict in enumerate(filters_dicts):
            ...
            if len(avg_values) != len(iteration_index):
                ...
                extended_avg_values = np.append(avg_values, [avg_values[-1]] * (len(iteration_index) - len(avg_values)))
                extended_sem_values = np.append(sem_values, [sem_values[-1]] * (len(iteration_index) - len(sem_values)))
                plt.plot(iteration_index, extended_avg_values, label=metric +'_ratio'+ weight +'_'+ algo+ '_data_num_' + str(data_num))
                plt.fill_between(iteration_index, extended_avg_values - extended_sem_values, extended_avg_values + extended_sem_values, alpha=0.2)
            else:
                plt.plot(iteration_index, avg_values, label=metric +'_ratio'+ weight +'_'+ algo+ '_data_num_' + str(data_num))
                plt.fill_between(iteration_index, avg_values - sem_values, avg_values + sem_values, alpha=0.2)
